...
Expected: all three namespaces have `ksp.io/environment=production` and `ksp.io/profile=baseline`. These YAML exports are E2E/config evidence, not a disaster-recovery or etcd backup.
